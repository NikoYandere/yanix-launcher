...
BACKGROUND_PATH = os.path.join(YANIX_PATH, "data/background.txt")
    ...
    def launch_game(self):
        ...
        if os.path.exists(path):
            try:
                ...
                game_process = subprocess.Popen(["wine", path], env=env)
            ...
            QMessageBox.critical(self, "Error", "The saved game path is invalid. Please select the executable again.")
