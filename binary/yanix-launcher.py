...
def show_buttons():
    ...
    for button, pos in zip(buttons, [(0.5, 0.3), (0.5, 0.4), (0.5, 0.5), (0.05, 0.95), (0.95, 0.95), (0.05, 0.05)]):
...
if not os.path.exists(YANIX_PATH):
    ...
    buttons = [
        ...
        tk.Button(top, text=LANGUAGES[current_lang]["exit"], font=("Arial", 10, "bold"), command=exit_launcher)
    ]
